...
class OpenRouterProvider(BaseAIProvider):
    @property
    def name(self) -> str:
        return "OpenRouter (Google Gemma-4-26b-a4b Free)"
    ...
    async def chat(self, prompt: str, system_instruction: str, timeout: float = 12.0) -> str:
        ...
        headers = {
            ...
            "HTTP-Referer": "https://kalvettu.heritage",
            "X-Title": "Kalvettu Tamil Temple Inscriptions",
            "Content-Type": "application/json",
        }
        # Exact free model requested by user
        models_to_try = [
